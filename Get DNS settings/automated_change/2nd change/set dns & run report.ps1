...
# csv file that the compiled list of DNS files will be created from
    ...
    $output_location = "C:\CSV\post_dns_change2_compiled.csv"
...
$CSV | ForEach-Object { 
    ...
    Write-Host "Setting DNS priority on $name using interface $index" -ForegroundColor Green
        ...
        Set-DnsClientServerAddress -ServerAddresses ('172.28.64.26','172.28.65.37','172.28.64.25','172.28.65.39') -InterfaceIndex $index 
