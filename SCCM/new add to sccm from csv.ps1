...
$File = Import-Csv "C:\Users\JTUCK\Downloads\test_sccm_servers.csv"
$logpath = “c:\temp”
...
$Search_mac = Get-CMDevice -Fast | Where-Object { $_.MACAddress -contains $Mac_Address } | Select -ExpandProperty Name
